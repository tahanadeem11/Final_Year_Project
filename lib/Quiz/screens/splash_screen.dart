...
import 'package:labquest/Quiz/providers/status_manager_provider.dart';
import 'package:labquest/Quiz/screens/done_screen.dart';
import 'package:labquest/Quiz/screens/home_page.dart';
import 'package:labquest/Quiz/screens/welcome_page1.dart';
...
class _SplashScreenState extends State<SplashScreen>{
  ...
  _navigatetohome() async{
    ...
    if (recievedValues[0]) {
      await Navigator.pushReplacement; context; MaterialPageRoute(builder: (context)=> WelcomePage()
    );
    } else {
      ...
      if (recievedValues[3] >=91 ){
        ...
        await Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (context)=> HomePage334()),
        );
      }
    }
  }
